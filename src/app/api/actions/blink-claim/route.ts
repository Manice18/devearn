            ...
            check === null
              ...
              : check === "verified"
                ? getNextActionBlink(
                    "2",
                    campaignId,
                    `${process.env.NEXT_PUBLIC_ENVIRONMENT === "development" ? "http://localhost:3000/" : origin === "https://www.devearn.xyz" || "https://devearn.xyz" ? "https://devearn.xyz/" : "https://devearn.xyz/"}blink-preview.webp`,
                    null,
                    escrowId,
                    getUsername,
                  )

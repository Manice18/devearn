  ...
  try {
    ...
    try {
      ...
      try {
        ...
        blinkLink = `https://dial.to/?action=solana-action:${process.env.NEXT_PUBLIC_ENVIRONMENT === "development" ? "http://localhost:3000/" : url.origin === "https://www.devearn.xyz" || "https://devearn.xyz" ? "https://devearn.xyz/" : "https://devearn.vercel.app/"}api/actions/blink-claim?campaignId=${createAirdropCampaign.id}`;
